/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/gui/PropertyTableModel.java#2 $
 ...
 *
 * @author  sean
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/gui/PropertyTableModel.java#2 $
 */
