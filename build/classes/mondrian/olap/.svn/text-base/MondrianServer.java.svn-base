/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/MondrianServer.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/MondrianServer.java#2 $
 * @since Jun 25, 2006
 */
