/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/FunTableImpl.java#2 $
...
public abstract class FunTableImpl implements FunTable {
    ...
    public FunDef getDef(
        ...
        if(funName.equalsIgnoreCase("Valorrr")) {
        	int i = 0;
        }
        
/*        if(funName.equalsIgnoreCase("Separatrix")) {
        	System.out.println("separatrix");
        }*/
