/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/ReflectiveMultiResolver.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/ReflectiveMultiResolver.java#2 $
 * @since Mar 23, 2006
 */
