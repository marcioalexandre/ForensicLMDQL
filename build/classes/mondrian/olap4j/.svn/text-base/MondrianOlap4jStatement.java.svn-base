/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap4j/MondrianOlap4jStatement.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap4j/MondrianOlap4jStatement.java#2 $
 * @since May 24, 2007
 */
