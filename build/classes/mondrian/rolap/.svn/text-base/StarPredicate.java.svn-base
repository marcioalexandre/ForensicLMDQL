/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/StarPredicate.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/StarPredicate.java#2 $
 * @since Jan 15, 2007
 */
