/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/ListColumnPredicate.java#4 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/ListColumnPredicate.java#4 $
 * @since Nov 2, 2006
 */
