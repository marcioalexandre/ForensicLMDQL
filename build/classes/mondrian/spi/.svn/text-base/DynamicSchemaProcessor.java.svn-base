/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/spi/DynamicSchemaProcessor.java#2 $
 ...
 *
 * @author hhaas
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/spi/DynamicSchemaProcessor.java#2 $
 */
