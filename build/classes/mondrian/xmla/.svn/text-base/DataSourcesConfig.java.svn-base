...
// on Sun Oct 19 16:36:17 BRT 2008
 ...
 * Revision is $Id: //open/mondrian-release/3.0/src/main/mondrian/xmla/DataSourcesConfig.xml#2 $
 * <p>This class was generated from XOM model 'datasourcesconfig' on Sun Oct 19 16:36:17 BRT 2008
 */
public class DataSourcesConfig {
	...
	public static class DataSources extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayElementArrayDiff("dataSources", dataSources, _cother.dataSources, _out, _indent+1);
			return _diff;
		}
	}
	...
	public static class DataSource extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayStringDiff("name", name, _cother.name, _out, _indent+1);
...
public static final String PROVIDER_TYPE_TDP = "TDP";
	...
	public static class Catalogs extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayElementArrayDiff("catalogs", catalogs, _cother.catalogs, _out, _indent+1);
			return _diff;
		}
	}
