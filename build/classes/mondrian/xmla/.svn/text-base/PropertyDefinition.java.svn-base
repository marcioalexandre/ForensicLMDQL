/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/xmla/PropertyDefinition.java#2 $
 ...
 * @author jhyde
 * @since May 2, 2003
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/xmla/PropertyDefinition.java#2 $
 */
