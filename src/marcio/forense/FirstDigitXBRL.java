...
public class FirstDigitXBRL implements UserDefinedFunction {
		...
		double zcritico = (double) 1.96; // valor crítico para Hipótese nula
											// po=pe.
		/*
		 * double significancia = Double.parseDouble("0,05"); //nivel de
		 * significancia aceitável System.out.println("Z critico: "+zcritico);
		...
		if (String.valueOf(param3).equals("serialized")) {
			...
			if (result == 0) {
				...
				/*
				 * impressão de todos os valores do documento for (BigDecimal
				...
				conclusao += "<tr><td colspan='2'>";
				/*
				 * impressão de todos os valores do documento conclusao +=
