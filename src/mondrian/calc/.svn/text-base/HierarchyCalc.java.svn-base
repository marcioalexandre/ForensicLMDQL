/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/calc/HierarchyCalc.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/calc/HierarchyCalc.java#2 $
 * @since Sep 26, 2005
 */
