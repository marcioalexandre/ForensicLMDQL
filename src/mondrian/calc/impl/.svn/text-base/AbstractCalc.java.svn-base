/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/calc/impl/AbstractCalc.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/calc/impl/AbstractCalc.java#2 $
 * @since Sep 27, 2005
 */
