...
// on Sun Oct 19 16:36:16 BRT 2008
 ...
 * <p>This class was generated from XOM model 'mondrian' on Sun Oct 19 16:36:16 BRT 2008
 */
...
public boolean isEnabled() {
	...
	public static class CubeUsages extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayElementArrayDiff("cubeUsages", cubeUsages, _cother.cubeUsages, _out, _indent+1);
			return _diff;
		}
	}
...
public String toString() {
	...
	public static class Union extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayElementArrayDiff("roleUsages", roleUsages, _cother.roleUsages, _out, _indent+1);
			return _diff;
		}
	}
	...
	public static class RoleUsage extends org.eigenbase.xom.ElementDef
	{
		...
		public boolean displayDiff(org.eigenbase.xom.ElementDef _other, java.io.PrintWriter _out, int _indent)
		{
			...
			_diff = _diff && displayAttributeDiff("roleName", roleName, _cother.roleName, _out, _indent+1);
			return _diff;
		}
	}
