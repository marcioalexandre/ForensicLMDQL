/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/QueryTimeoutException.java#2 $
 ...
 *
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/QueryTimeoutException.java#2 $
 */
