/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/GenerateFunDef.java#3 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/GenerateFunDef.java#3 $
 * @since Mar 23, 2006
 */
