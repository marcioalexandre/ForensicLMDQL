/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/DistinctFunDef.java#3 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/fun/DistinctFunDef.java#3 $
 * @since Jun 10, 2007
*/
