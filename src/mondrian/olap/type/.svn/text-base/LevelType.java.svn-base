/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/type/LevelType.java#2 $
 ...
 * @author jhyde
 * @since Feb 17, 2005
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap/type/LevelType.java#2 $
 */
