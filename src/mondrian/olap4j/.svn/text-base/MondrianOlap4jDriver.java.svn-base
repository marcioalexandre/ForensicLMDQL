/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/olap4j/MondrianOlap4jDriver.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/olap4j/MondrianOlap4jDriver.java#2 $
 * @since May 22, 2007
 */
