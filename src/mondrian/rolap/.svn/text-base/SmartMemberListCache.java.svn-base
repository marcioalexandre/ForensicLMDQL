/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/SmartMemberListCache.java#2 $
 ...
 * @author av
 * @since Nov 21, 2005
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/SmartMemberListCache.java#2 $
 */
