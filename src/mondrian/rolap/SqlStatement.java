...
public class SqlStatement {
    ...
    public void execute() throws SQLException {
        ...
        else // não tem conexão jdbc e sim com XML #Paulo Caetano
        ...
        try {
            ...
            if(Parameters.databaseType==Database.RELATIONAL){ // executando relacional #Paulo Caetano
            ...
            } else {// submetendo ao XML do DB2 e não ao relacional MySQL #Paulo Caetano
            	// 	Em alguns pontos não pude localizar onde era carregado o connectString do Mondrian, nem de onde pegava,
            	// por isso tive que criar essa variável, para atribuir um valor padrão, caso não achasse #Paulo Caetano
            	String sql2xqueryWebPath = Parameters.mdxConnProperties.get(RolapConnectionProperties.SQL2XQuery.name())==null?
            									"/WEB-INF/lib/sql2xquery.xml": // padrão
                ...
                // carregando o conteúdo do arquivo de configuração sql2xquery
                if(Parameters.xmlSQL2XQueryContent==null){
                	InputStream is = new FileInputStream(sql2xqueryFile);
                    String texto = "";
                    try{ // lendo conteúdo do xml (catalog) 
                    ...
                    Parameters.xmlSQL2XQueryContent = texto; // colocando como parâmetro
