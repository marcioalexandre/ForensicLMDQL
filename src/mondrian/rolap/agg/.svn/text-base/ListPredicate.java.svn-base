/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/ListPredicate.java#3 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/ListPredicate.java#3 $
 */
