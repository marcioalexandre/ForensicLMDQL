/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/LiteralStarPredicate.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/agg/LiteralStarPredicate.java#2 $
 * @since Nov 2, 2006
 */
