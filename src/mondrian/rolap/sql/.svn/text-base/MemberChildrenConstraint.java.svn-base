/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/sql/MemberChildrenConstraint.java#2 $
 ...
 * @author av
 * @since Nov 2, 2005
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/sql/MemberChildrenConstraint.java#2 $
 */
