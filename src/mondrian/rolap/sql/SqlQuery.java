/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/sql/SqlQuery.java#5 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/rolap/sql/SqlQuery.java#5 $
 */
public class SqlQuery {
    ...
    public static SqlQuery newQuery(DataSource dataSource, String err) {
    	if(Parameters.databaseType==Database.XML){ // XML tem que obter o dialeto antes #Paulo Caetano
    ...
    public static class Dialect {
        ...
        public static Dialect create(final DatabaseMetaData databaseMetaData) {
        		...
        		// se é banco XML, atribui dialeto MySQL #Paulo Caetano
        	if(Parameters.databaseType==Database.XML){
                Set<List<Integer>> sup = new HashSet<List<Integer>>();
                sup.add(new ArrayList<Integer>(Arrays.asList(1004, 1007)));
                sup.add(new ArrayList<Integer>(Arrays.asList(1004, 1008)));
                sup.add(new ArrayList<Integer>(Arrays.asList(1003, 1007)));
                sup.add(new ArrayList<Integer>(Arrays.asList(1003, 1008)));
                return new Dialect(
                        "`",
                        "MySQL",
        ...
        public static Dialect create(DataSource dataSource) {
            ...
            try {
                conn = dataSource.getConnection(); // vai dar erro se for XML #Paulo Caetano
