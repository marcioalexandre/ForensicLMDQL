/*
// $Id: //open/mondrian-release/3.0/src/main/mondrian/spi/CatalogLocator.java#2 $
 ...
 * @author Gang Chen
 * @since December, 2005
 * @version $Id: //open/mondrian-release/3.0/src/main/mondrian/spi/CatalogLocator.java#2 $
 */
